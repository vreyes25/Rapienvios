...
if($_SESSION['usuario'] == null || $_SESSION['usuario'] == ''){
    ...
    $sql = "SELECT `idHistorial`, `idCasillero`, fechaInicio, IF(historialpreciocasillero.fechaFinal=NULL,' ',fechaFinal) as 'fechaFinal',precio
    FROM `historialpreciocasillero`;";
    ...
    while ( $fila = mysqli_fetch_array($resultado)) {
        ...
        $pdf->Cell(35, 5, utf8_decode($fila['idCasillero']), 1, 0, "C"); 
...
$pdf->Output('ReportePreciosCasilleros'.date('d/m/Y g:i:s a').'.pdf','i');
